...
#define BSX_CONSTANT_UNIT_SCALING_ACC_OUTPUT2MPS2                              \
	(BSX_CONSTANT_GRAVITY_STANDARD /                                       \
	 1000.0f) //!< internal unit [mg] to [m/s^2]
...
#define BSX_CONSTANT_UNIT_SCALING_ACC_MPS22OUTPUT                              \
	(1000.0f /                                                             \
	 BSX_CONSTANT_GRAVITY_STANDARD) //!< [m/s^2] to internal unit [mg]
#define BSX_CONSTANT_UNIT_SCALING_GYRO_OUTPUT2DEGPS                            \
	(0.06103515625f) //!< internal unit [0.061 deg/s] to [deg/s]; note: 2000/2^15 = 0.061
#define BSX_CONSTANT_UNIT_SCALING_GYRO_OUTPUT2RADPS                            \
	(0.001065264436031695f) //!< internal unit [0.0011 rad/s] to [deg/s]; note: 2000/2^15*pi/180 = 0.0011
#define BSX_CONSTANT_UNIT_SCALING_GYRO_DEGPS2OUTPUT                            \
	(16.384f) //!< [deg/s] to internal unit [0.061 deg/s]; note: 2^1/2000 = 16.384
#define BSX_CONSTANT_UNIT_SCALING_GYRO_RADPS2OUTPUT                            \
	(938.7340515423410f) //!< internal unit [0.0011 rad/s] to [deg/s]; note: 2000/2^15*pi/180 = 0.0011
