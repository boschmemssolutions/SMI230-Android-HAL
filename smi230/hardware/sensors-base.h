...
enum { SENSOR_HAL_NORMAL_MODE = 0,
       SENSOR_HAL_DATA_INJECTION_MODE = 1,
};

enum { SENSOR_TYPE_META_DATA = 0,
...
enum { SENSOR_STATUS_NO_CONTACT = -1, // (-1)
...
enum { META_DATA_FLUSH_COMPLETE = 1u, // 1
};
