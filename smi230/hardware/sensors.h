...
#define SENSORS_DEVICE_API_VERSION_0_1                                         \
	HARDWARE_DEVICE_API_VERSION_2(0, 1, SENSORS_HEADER_VERSION)
#define SENSORS_DEVICE_API_VERSION_1_0                                         \
	HARDWARE_DEVICE_API_VERSION_2(1, 0, SENSORS_HEADER_VERSION)
#define SENSORS_DEVICE_API_VERSION_1_1                                         \
	HARDWARE_DEVICE_API_VERSION_2(1, 1, SENSORS_HEADER_VERSION)
#define SENSORS_DEVICE_API_VERSION_1_2                                         \
	HARDWARE_DEVICE_API_VERSION_2(1, 2, SENSORS_HEADER_VERSION)
#define SENSORS_DEVICE_API_VERSION_1_3                                         \
	HARDWARE_DEVICE_API_VERSION_2(1, 3, SENSORS_HEADER_VERSION)
#define SENSORS_DEVICE_API_VERSION_1_4                                         \
	HARDWARE_DEVICE_API_VERSION_2(1, 4, SENSORS_HEADER_VERSION)
 ...
 */
enum { SENSORS_BATCH_DRY_RUN = 0x00000001,
...
#define SENSOR_STRING_TYPE_LINEAR_ACCELERATION                                 \
...
#define SENSOR_STRING_TYPE_GAME_ROTATION_VECTOR                                \
	"android.sensor.game_rotation_vector"
#define SENSOR_STRING_TYPE_GYROSCOPE_UNCALIBRATED                              \
	"android.sensor.gyroscope_uncalibrated"
#define SENSOR_STRING_TYPE_SIGNIFICANT_MOTION                                  \
...
#define SENSOR_STRING_TYPE_WRIST_TILT_GESTURE                                  \
	"android.sensor.wrist_tilt_gesture"
#define SENSOR_STRING_TYPE_DEVICE_ORIENTATION                                  \
...
#define SENSOR_STRING_TYPE_DYNAMIC_SENSOR_META                                 \
	"android.sensor.dynamic_sensor_meta"
#define SENSOR_STRING_TYPE_ADDITIONAL_INFO "android.sensor.additional_info"
#define SENSOR_STRING_TYPE_LOW_LATENCY_OFFBODY_DETECT                          \
	"android.sensor.low_latency_offbody_detect"
#define SENSOR_STRING_TYPE_ACCELEROMETER_UNCALIBRATED                          \
...
struct sensors_direct_mem_t {
	...
	const struct native_handle *
		handle; // shared memory handle, which is interpreted differently
	// depending on type
};
...
struct sensors_poll_device_t {
	...
	int (*activate)(struct sensors_poll_device_t *dev, int sensor_handle,
			int enabled);
	int (*setDelay)(struct sensors_poll_device_t *dev, int sensor_handle,
			int64_t sampling_period_ns);
	int (*poll)(struct sensors_poll_device_t *dev, sensors_event_t *data,
		    int count);
};
...
typedef struct sensors_poll_device_1 {
     ...
     */
	int (*inject_sensor_data)(struct sensors_poll_device_1 *dev,
